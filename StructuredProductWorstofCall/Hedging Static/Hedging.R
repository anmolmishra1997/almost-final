  setwd("D:/Anmol/Workspace/Anmol Intern/StructuredProductWorstOfCall/Hedging Static")
  library('Rcpp')
  ...
  "This block reads the values of sigma and mu for each stock, as well as the correlation matrix."
  ...
  #   powerraised = days - t(replicate(scenarios , 1:days))
